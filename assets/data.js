export const largeCardSections = [
  {
    id: 1,
    title: "Huming Tuning",
    snippet: "Measure humidity and temperature with an app",
    cards: [
      {
        id: 19,
  ...
  {
    id: 2,
    title: "Huming AutoTuning",
    snippet:
      "Measure humidity and temperature and automatically and automatically let the system tune your room climate",
    cards: [
      {
        id: 22,
  ...
  {
    id: 3,
    title: "Huming MasterTune",
    snippet:
      "Measure humidity and temperature with an app and automatically let the system tune your room climate",
    cards: [
      {
        id: 22,
        title: "Vintage 1864 Fire Extinguisher",
